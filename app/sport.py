...
def GetIds(league, team):
    ...
    return SeasonId, RoundId, TeamId, LogoUrl
...
if __name__ == "__main__":
    ...
    league, team = SetParams()
    print("LEAGUE:", league)
    print("TEAM:", team)

    SeasonId, RoundId, TeamId, LogoUrl = GetIds(league, team)
    if not SeasonId or not RoundId or not TeamId or not LogoUrl:
